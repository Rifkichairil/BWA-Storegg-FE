...
export default function CheckoutDetails() {
    ...
    useEffect(() => {
        ...
        console.log('datatopip : ', dataTopupLocal);
    ...
    return (
        <>
            <div className="purchase pt-md-50 pt-30">
                ...
                <p className="text-lg color-palette-1 mb-20">Item <span className="purchase-details">{dataTopup.nominalItem.coinQuantity} Diamonds</span></p>
                <p className="text-lg color-palette-1 mb-20">Price <span className="purchase-details"><NumberFormat value={itemPrice} prefix='Rp. ' displayType='text' thousandSeparator='.' decimalSeparator=',' />     </span></p>
                <p className="text-lg color-palette-1 mb-20">Tax (10%) <span className="purchase-details"><NumberFormat value={tax} prefix='Rp. ' displayType='text' thousandSeparator='.' decimalSeparator=',' />     </span>
                </p>
